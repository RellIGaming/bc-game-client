...
const slots = [
  { id: 1, name: "Rabbit", provider: "JILI", rtp: "A-44", image: card2 },
  { id: 2, name: "Fortune Gems 3", provider: "JILI", rtp: "4-70", image: card3 },
  { id: 3, name: "Money Coming", provider: null, rtp: null, image: card4 },
  { id: 4, name: "Wild Bandito", provider: "PGSoft", rtp: "5-54", image: card5 },
  { id: 5, name: "Fortune Tiger", provider: "PGSoft", rtp: "5-29", image: card6 },
  { id: 6, name: "Aztec Coins", provider: "JILI", rtp: null, image: card7 },
  { id: 7, name: "Fortune Coins", provider: "JILI", rtp: "4-7", image: card8 },
  { id: 8, name: "Fortune Gems 2", provider: "JILI", rtp: null, image: card9 },
];
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <h2 className="text-lg font-bold text-foreground">Slots</h2>
        <div className="flex items-center gap-2">
          <button 
            onClick={() => navigate("/category/slots")}
          ...
          >
            <div className="aspect-[3/4] relative">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-2">
                <h3 className="text-white font-bold text-xs text-center truncate">{slot.name}</h3>
              </div>
