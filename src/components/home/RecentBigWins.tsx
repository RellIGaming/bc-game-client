...
import BetSlipModal from "../sports/BetSlipModal";
...
const mockWins = [
  ...
  { id: 3, game: "Mines24", user: "Alanstp.oa", amount: "203.45K", currency: "USD", image: card4 },
  ...
  { id: 7, game: "MAXW...", user: "Bofela79", amount: "108.24K", currency: "USD", image: card8 },
  ...
  { id: 10, game: "USDrake", user: "Gtghnom", amount: "97.35K", currency: "USDT", image: card11 },
...
const RecentBigWins = () => {
  ...
  const [selectedWin, setSelectedWin] = useState<typeof mockWins[0] | null>(null);
