                ...
                {depositTab === "crypto" ? (
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center justify-between flex-wrap gap-3">
                            <label className="text-sm text-muted-foreground">Deposit Currency</label>
                            <div className="flex items-center gap-3">
                                <button onClick={() => setGuaranteeOpen(true)} className="px-3 py-1.5 bg-primary/20 rounded-full text-xs text-primary font-semibold flex items-center gap-1 hover:bg-primary/30 transition-colors">
                                    🎁 7-Day Deposit Guarantee <Info className="w-3 h-3" />
                                </button>
                        ...
                        {isUSD ? (
                            ...
                            <>
                                ...
                                {/* Deposit Methods */}
                                <div>
                                    <h4 className="font-medium text-foreground mb-4">Deposit Method</h4>
                                    {categories.map((cat) => {
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            <label className="text-sm text-muted-foreground mb-2 block">
                                                Deposit Amount ({cfg.range} {cfg.symbol})
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                {/* {depositAmount && (
                                                    <span className="text-sm text-primary font-semibold whitespace-nowrap">
                                                        Extra +{selectedFiatCurrency.name} {(parseFloat(depositAmount || "0") * 1.8).toFixed(2)}
                                                    </span>
                                                )} */}
