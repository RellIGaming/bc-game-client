...
const Oldwithdraw = () => {
  ...
  const handleSaveAddress = (data: any) => {
    ...
    // auto-fill address
    setWithdrawAddress(data.address);
  };
  useEffect(() => {
    fetchBalance();
  }, []);
  ...
  const handleWithdraw = async () => {
    ...
    if (!withdrawAddress || withdrawAddress.trim() === "") {
      return alert("Enter withdrawal address");
    }
      ...
      <div className="space-y-4">
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="font-medium text-white">{selected?.currency?.toUpperCase() || "Select"}</span>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-white font-medium">
                        {wallet?.currency?.toUpperCase() || "N/A"}
                      </span>
                    </div>
                  ...
                  <div className="p-3 text-sm text-gray-300 flex items-center justify-between">
                    ...
                    {savedAddresses.length === 0 ? (
                      ...
                      savedAddresses.map((a, i) => (
                        <div key={i} onClick={() => setWithdrawAddress(a.address)}>
                          {a.name} - {a.address}
                        </div>
                      ))
                    )}
        ...
        <div className="flex justify-end">
          <span className="text-sm text-muted-foreground">Available: <span className="text-foreground">
            {selected?.balance || 0}
          </span></span>
        </div>
        ...
        <Button onClick={handleWithdraw}
          disabled={loading || !withdrawAddress.trim() || !withdrawAmount} className="w-full h-12 bg-primary text-primary-foreground hover:bg-primary/90 font-semibold">
